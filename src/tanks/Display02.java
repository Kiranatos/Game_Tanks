...
public class Display02 {
    ...
    public static void render() {
        ...
        int num0001 = (int) (350 + (Math.sin(delta) * 200));
        bufferGraphics.fillOval( num0001, 250, 100, 100);
        
        ((Graphics2D)bufferGraphics).setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); //Сглаживание
        int num0002 = (int) (500 + (Math.sin(delta) * 200));
        bufferGraphics.fillOval( num0002, 250, 100, 100);
        ((Graphics2D)bufferGraphics).setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); //выкл Сглаживание
